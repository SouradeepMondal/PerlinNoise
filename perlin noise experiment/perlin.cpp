...
#define maxPrimeIndex 10 //10
int primeIndex = 0;  //seed value chk 275?//0
...
int primes[maxPrimeIndex][3] = {
  ...
  //{ 186559413, 876641544, 659826692 } //maxPrimeIndex set to 11
};
